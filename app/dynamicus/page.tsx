...
import DynamicusHeader from "../components/dynamicus/dynamicus-header";
    ...
    <div className={`${styles.page} flex flex-col gap-4`}>
      ...
      <div className="flex gap-4">
        ...
        <Card className="flex-grow">
          <div className="flex gap-12 mt-2 justify-between items-center">
            <div className="flex flex-col gap-2 w-[45%] text-justify">
              <Typography variant="h1">Responsabilidades</Typography>
              <p>Mis principales responsabilidades fueron: </p>
              <p>
                ✔️ Responsable del desarrollo completo del frontend en múltiples
                aplicaciones web, utilizando tecnologías como{" "}
                <strong>
              ...
              <p>
                ✔️
                <strong>Colaboración constante con el equipo de backend</strong>
              ...
              <p>
                ...
                , incluyendo el diseño de estructuras modulares y reutilizables,
                lo que redujo los tiempos de desarrollo y facilitó la
                incorporación de nuevas funcionalidades.
              </p>
              <p>
                ✔️ <strong>Optimización de procesos de desarrollo</strong>{" "}
                mediante el uso de <strong>Vite</strong> para mejorar la
                velocidad de compilación y <strong>Refine</strong> para acelerar
                la construcción de aplicaciones empresariales.
              </p>
            </div>
          ...
          <div className="flex gap-12 mt-6 justify-between items-center">
            <div className="flex flex-col gap-2 w-[100%]">
              <img
            ...
            <div className="flex flex-col gap-2 w-[45%] text-justify">
              ...
              <p>
                ...
                <strong>tres frontend developers y un backend developer</strong>
                , pero con el tiempo quedé como la{" "}
                <strong>única responsable del frontend</strong>. Mis principales
                tareas fueron:
              </p>
              <p>
                ✔️ <strong>Diseño y desarrollo de interfaces</strong>: Creación
                de componentes reutilizables para optimizar el desarrollo y
              ...
              <p>
                ...
                <strong>CRUD eficiente</strong>, lo que permitió automatizar el
                manejo de datos según las rutas definidas.
                <br />
                Por ejemplo, una consulta a <em>calp.com/usuarios</em> realizaba
                automáticamente el fetch de la base de datos de usuarios,
                simplificando la creación de interfaces tipo ABM (Alta, Baja y
                Modificación).
              </p>
              <p>
                ✔️ <strong>Fetchs personalizados</strong>: En los casos donde la
                lógica de negocio requería mayor flexibilidad, utilicé{" "}
